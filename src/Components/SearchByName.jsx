...
const SearchByName = ({ mealsData }) => {
	...
	return (
		<div className="pb-8 space-y-4">
			<div
				className="relative py-60 px-60 bg-[url('https://images.gastronom.ru/bvZeW6xtPp9yJ3rr1g1Rsm38r7Ika71oitA-QpOf-HU/pr:default/g:ce/rs:auto:0:0:0/Z2FzdHJvbm9tL2FsbC1pbWFnZXMvNTg5NzA0NDItNjQxZS00NjhlLTg4NzAtMDcwYThlMzY2YmRkLmpwZw')] bg-cover bg-center rounded-lg">
				<div className="absolute inset-0 bg-black/50 rounded-lg"></div>
				<h2 className="relative text-6xl font-bold mb-10">Поиск по названию блюда</h2>
